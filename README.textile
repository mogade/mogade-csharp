...
(we call it the Driver, because its assumed this library will be wrapped in a higher level platform library, such as the "WindowsPhone":https://github.com/mogade/mogade-windwosphone one)
